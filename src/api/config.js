const config = {
  ...
  title: 'Ein Jahr in fünf Tagen',
  year: 2023,
  startDate: new Date('2023-07-24'),
  endDate: new Date('2023-07-28'),
  registrationStart: new Date('2023-05-01'),
  registrationDeadline: new Date('2023-06-19'),
  waiverDeadline: new Date('2023-06-19'),
  maxParticipants: 50,
  earlyCarePlaces: 20,
  prices: {
    base: 40,
  ...
  kuchen: [
    { date: '2023-07-24', amount: 9 },
    { date: '2023-07-25', amount: 9 },
    { date: '2023-07-26', amount: 9 },
    { date: '2023-07-27', amount: 9 },
  ],
  genders: [
